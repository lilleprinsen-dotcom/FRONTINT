...
class FrontSystemsPriceListClient
{
    public function upsertPriceList(Connection $connection, string $name, array $prices): Response
    {
        return Http::timeout(15)
            ...
            ->post($this->url($connection, '/api/PricelistV2'), [
                'name' => $name,
                'prices' => $prices,
            ]);
    }

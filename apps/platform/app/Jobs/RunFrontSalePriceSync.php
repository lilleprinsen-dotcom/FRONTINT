...
use App\Models\User;
use App\Services\ProductSync\FrontSalePriceSyncRunner;
use Illuminate\Contracts\Queue\ShouldQueue;
use Illuminate\Foundation\Queue\Queueable;

class RunFrontSalePriceSync implements ShouldQueue
{
    use Queueable;
    ...
    public function handle(FrontSalePriceSyncRunner $runner): void
    {

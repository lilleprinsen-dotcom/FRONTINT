...
use App\Models\User;
use App\Services\ProductSync\FrontStockSyncRunner;
use Illuminate\Contracts\Queue\ShouldQueue;
use Illuminate\Foundation\Queue\Queueable;

class RunFrontStockSync implements ShouldQueue
{
    use Queueable;
    ...
    public function handle(FrontStockSyncRunner $runner): void
    {

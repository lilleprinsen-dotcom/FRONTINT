...
@section('content')
    <section class="panel">
        <h1>Woo Readiness</h1>
        <p>
            This page checks the latest WooCommerce product sample and shows what looks ready before any Front setup is available.
        </p>
        ...
        @if ($snapshot)
            ...
            <div class="action-row">
                <a class="button secondary" href="{{ route('connections.discovery', $snapshot->connection) }}">Open discovery</a>
        ...
        <section class="grid">
            <div class="panel">
                ...
                <table>
                    ...
                    <tr>
                        <th>Products</th>
                        <td>{{ $counts['products'] }}</td>
                    </tr>
                    <tr>
                        <th>Variable parents</th>
                        <td>{{ $counts['variable_parents'] }}</td>
                    </tr>
                    <tr>
                        <th>Sellable variations</th>
                        <td>{{ $counts['sellable_variations'] }}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
